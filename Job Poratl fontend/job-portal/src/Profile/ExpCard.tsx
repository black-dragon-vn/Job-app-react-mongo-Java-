...
const ExCard = ({ 
    ...
    // ✅ FIX: Call onSave với index và expData
    const handleSave = (index: number, expData: Experience) => {
        onSave(index, expData);
    };
        ...
        return (
            <div className="text-center py-12">
                <div className="text-mine-shaft-600 mb-4">
                    ...
                    <p className="text-mine-shaft-500">Add your first experience above</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="flex flex-col gap-8">
            {data.map((exp, index) => (
                <div key={index}>
                    {editingIndex === index ? (
                        // EDIT MODE - Show ExpInput
                        <ExpInput
                            experience={exp}
                            index={index}
                            onUpdate={onChange}
                            onRemove={handleDelete}
                            onSave={(idx, expData) => handleSave(idx, expData)} // ✅ Pass expData
                            onExit={handleExit}
                        />
                    ) : (
                        // VIEW MODE - Show Card
                        <div className="group relative p-5 rounded-xl bg-mine-shaft-900/50 border border-mine-shaft-800 hover:border-cyan-500/30 hover:bg-mine-shaft-900/80 transition-all duration-300">
                            ...
                            <div className="relative flex justify-between items-start">
                                <div className="flex gap-4 items-start flex-1">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <div className="text-base text-mine-shaft-300 flex items-center gap-2">
                            ...
                            <div className="relative mt-4 pl-16 text-sm text-mine-shaft-400 leading-relaxed">
